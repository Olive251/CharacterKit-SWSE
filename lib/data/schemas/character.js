...
const Character = new mongoose.Schema({
    ...
    status: Character_HP,
    // defenses: Character_Defenses, //defences are determined wholey by other aspects, no need for stored info
...
module.exports = mongoose.models.Character || mongoose.model("Character", Character);